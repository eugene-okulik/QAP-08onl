...
month_select = Select(Chrome_driver.find_element(By.CLASS_NAME,
                                                 'react-datepicker__month-select'))
month_select.select_by_value("0")

year_select = Select(Chrome_driver.find_element(By.CLASS_NAME,
...
hobbies_sport = Chrome_driver.find_elements(By.XPATH,
                                        '//label[@class="custom-control-label"]')
hobbies_sport[3].click()

hobbies_reading = Chrome_driver.find_elements(By.XPATH,
                                        '//label[@class="custom-control-label"]')
hobbies_reading[4].click()

hobbies_music = Chrome_driver.find_elements(By.XPATH,
                                            '//label[@class="custom-control-label"]')
...
state_form = Chrome_driver.find_element(By.XPATH,
