...
tulip = Tulips(6, 'yellow', 4, 'Tulip')
rose = Roses(4, 'white', 9, 'Rose')
orchid = Orchids(9, 'white', 14, 'Orchid')
chamomile = Chamomiles(3, 'blue', 7, 'Chamomile')
lily = Lily(12, 'purple', 6, 'Lily')
flowers1 = [tulip, rose, orchid, chamomile, lily]
flowers2 = [rose, orchid, lily]
flowers3 = [tulip, chamomile]
bouquet1 = Bouquet(flowers1)
bouquet2 = Bouquet(flowers2)
bouquet3 = Bouquet(flowers3)
print(bouquet1.find_freshness(9))
print(bouquet2.find_price(7))
