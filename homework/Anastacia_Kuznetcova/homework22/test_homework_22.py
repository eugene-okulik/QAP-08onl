...
def test_check_cart_product(driver):
    driver.get('https://www.demoblaze.com/index.html')
    product_name = driver.find_elements(By.CLASS_NAME, 'hrefch')
    product_name[0].send_keys(Keys.LEFT_CONTROL, Keys.ENTER)
...
def test_choose_element(driver):
...
def test_check_alert_txt(driver):
